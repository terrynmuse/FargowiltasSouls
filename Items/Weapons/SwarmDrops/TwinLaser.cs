    ...
    public class TwinLaser : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.value = Item.sellPrice(0,
                3); //  How much the item is worth, in copper coins, when you sell it to a merchant. It costs 1/5th of this to buy it back from them. An easy way to remember the value is platinum, gold, silver, copper or PPGGSSCC (so this item price is 3gold)
        }
    }
}