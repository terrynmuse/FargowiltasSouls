	...
	public class PhantasmalSphere : ModProjectile
	{
		...
		public override void Kill(int timeleft)
		{
			for (int num468 = 0; num468 < 20; num468++)
			{
				...
				num469 = Dust.NewDust(new Vector2(projectile.Center.X, projectile.Center.Y), projectile.width, projectile.height, 15, -projectile.velocity.X * 0.2f, -projectile.velocity.Y * 0.2f, 100);
				Main.dust[num469].velocity *= 2f;
			}
		}
