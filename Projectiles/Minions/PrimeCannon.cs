			...
			if (projectile.ai[0] == 0f)
			{
				...
				if (flag31 && projectile.ai[1] == 0f)
				{
					...
					if (Main.myPlayer == projectile.owner)
					{
						...
						int num777 = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, value16.X, value16.Y, mod.ProjectileType("PrimeCannonBall"), projectile.damage, 0f, projectile.owner, 0f, 0f);
						projectile.netUpdate = true;
					}
				}
			}
