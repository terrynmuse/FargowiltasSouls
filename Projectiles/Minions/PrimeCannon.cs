        ...
        public override void AI()
        {
            ...
            for (int num651 = 0; num651 < 200; num651++)
            {
                ...
                if (nPc2.CanBeChasedBy(projectile))
                {
                    ...
                    if ((Vector2.Distance(projectile.Center, vector58) > num652 && num652 < num768 || !flag31) &&
            ...
            if (projectile.ai[0] == 0f)
            {
                ...
                if (flag31 && projectile.ai[1] == 0f)
                {
                    ...
                    if (Main.myPlayer == projectile.owner)
                    {
                        ...
                        int num777 = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, value16.X, value16.Y, mod.ProjectileType("PrimeCannonBall"), projectile.damage, 0f,
                            projectile.owner);
                        projectile.netUpdate = true;
                    }
                }
