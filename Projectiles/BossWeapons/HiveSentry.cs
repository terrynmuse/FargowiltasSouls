        ...
        public override void AI()
        {
            ...
            if (projectile.ai[1] >= 120)
            {
                ...
                if (npcIndex != -1)
                {
                    ...
                    for (int i = 0; i < 10; i++)
                    {
                        Projectile.NewProjectile(projectile.Center, new Vector2(Main.rand.Next(-10, 10), Main.rand.Next(-10, 10)), ProjectileID.Bee, projectile.damage, 0, projectile.owner);
                    }
