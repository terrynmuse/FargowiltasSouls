    ...
    public class LeashFlail : ModProjectile
    {
		...
		public override void AI()
		{
            ...
            if ((int)projectile.ai[0] == 1f && projectile.owner == Main.myPlayer && eyeSpawn)
            {
                ...
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, vector55.X, vector55.Y, mod.ProjectileType("EyeProjectile"), projectile.damage, projectile.knockBack, projectile.owner, -10f);
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D texture = ModLoader.GetTexture("FargowiltasSouls/Projectiles/BossWeapons/LeashFlailChain");
