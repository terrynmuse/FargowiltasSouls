...
namespace FargowiltasSouls.Projectiles.Masomode
{
    public class PhantasmalDeathrayGolem : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D texture2D20 = mod.GetTexture("Projectiles/Masomode/PhantasmalDeathrayGolem2");
            Texture2D texture2D21 = mod.GetTexture("Projectiles/Masomode/PhantasmalDeathrayGolem3");
