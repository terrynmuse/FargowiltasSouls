            ...
            if (FargoWorld.MasochistMode)
            {
                ...
                switch (masoAI)
                {
                        ...
                        if (npc.life < npc.lifeMax * .5f && npc.HasPlayerTarget)
                        {
                            ...
                            if (Counter >= 5) //spray random slime balls
                            {
                                ...
                                /*for (int i = 0; i < 3; i++)
                                {
                                    ...
                                    speed.Normalize();
                                    speed *= 12 + Main.rand.Next(-50, 51) * 0.04f;
                                    if (speed.X < 0)
                                    ...
                                    int proj = Projectile.NewProjectile(new Vector2(npc.Center.X + Main.rand.Next(-5, 5), npc.Center.Y - 15), speed, mod.ProjectileType("SlimeBall"), npc.damage / 4, 0f, Main.myPlayer);
                                    Main.projectile[proj].friendly = false;
                                    Main.projectile[proj].hostile = true;
                                    Main.projectile[proj].timeLeft = 480;
                                }*/
                                        ...
                                        for (int i = 0; i < 3; i++)
                                        {
                                            ...
                                            if (bodyPart.active)
                                            {
                                                ...
                                                else if (bodyPart.type == NPCID.MoonLordHand)
                                                {
                                                    ...
                                                    {
                                                        if (Main.netMode != 1)
                                                            Projectile.NewProjectile(bodyPart.Center, speed, ProjectileID.CultistBossFireBall, 25, 0f, Main.myPlayer);
                                        ...
                                        for (int i = 0; i < 3; i++)
                                        {
                                                ...
                                                bodyPart.type == NPCID.MoonLordHand))
                                            {
                                                ...
                                                for (int j = -1; j <= 1; j += 2) //aim above and below player
                                                {
                                                    ...
                                                    {
                                                        Projectile.NewProjectile(bodyPart.Center, speed.RotatedBy(Math.PI / 96 * k), ProjectileID.NebulaLaser, 35, 0f, Main.myPlayer);
                                                    }
                                                }
                                            }
                                        }
                                    ...
                                    if (Timer == 2) //FIRE LASER
                                    {
                                        ...
                                        if (t != -1)
                                        {
                                            if (Main.netMode != 1)
                                            {
                                                ...
                                                Vector2 speed = Vector2.UnitX.RotatedBy(npc.localAI[0] - rotationDirection * 60f);
                                                if (Main.netMode != 1)
                                                    Projectile.NewProjectile(npc.Center, speed, mod.ProjectileType("PhantasmalDeathrayML"),
                                                        75, 0f, Main.myPlayer, rotationDirection, npc.whoAmI);
                                            }
                                        }
                                    }
                                    npc.netUpdate = true;
                    ...
                    case 103: // biome mimics
                        ...
                        /*Vector2 vector3 = npc.Center + new Vector2((float)(-(float)this.direction * 20), (float)(this.height / 2 - 1));
            ...
            if (FargoWorld.MasochistMode)
			{
                ...
                else //all the hardmode
                {
                    ...
                    if (surface)
                    {
                        ...
                        if (NPC.downedGolemBoss && Main.raining)
                        {
